...
<div class="container mb-4 bg-white" id="div1">
	<div class="container row" id="div2">
			...
			<img src="images/snsProfile/${p3View.iProfilePath}" alt="프로필이미지" class="rounded-circle" id="profileImg">
			</div>
			...
			<div class="container col">
				...
				<div class="mt-2">
					<button id="myModal" class="d-none btn btn-warning" data-toggle="modal" data-target="#myModal1"><i class="fas fa-plus"></i></button>
				</div>
			</div>
	</div>
...
$(document).ready(function(){
	...
	$("#btn").click(function(){
		let pImg = document.getElementById("profileImg").src
		alert(pImg);
	});
