...
<div id="mainRegion" class="container mt-5 p-0">
	...
	<h2 class="text-center threeDEffect mt-3">${contentView.bTitle}</h2>
	
	<form action="modify" method="post" id="modiContent">
		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
		<div class="form-group">
			<input type="hidden" class="form-control" id="uId" name="bId"	value="${contentView.bId}" readonly />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="hidden" class="form-control" id="title" name="bTitle" value="${contentView.bTitle}" readonly>

		<div class="form-group">
			<label for="content">내용</label>
			<div class="container" id="content" style="border: 1px solid grey; min-height:300px">
				${contentView.bContent}
			</div>
		</div>
		<a href="board1" id="contentBoard" class="btn btn-primary">목록보기</a> &nbsp;&nbsp;
